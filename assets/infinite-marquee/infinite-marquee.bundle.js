...
class InfiniteMarquee {
          ...
          , s = () => {
            if (this.isMarqueeInitialized) {
                const s = this.mobileSettings.direction || this.direction
                  ...
                  , l = t.matches && this.mobileSettings.speed || this.speed;
                if (e.style.setProperty('--_speed', `${l}ms`),
    ...
    destroy(e, t) {
        if (e) {
            ...
            if (s) {
                if (s.querySelectorAll('[aria-hidden="true"]').forEach((e => {
                    s.removeChild(e)
                }
                )),
